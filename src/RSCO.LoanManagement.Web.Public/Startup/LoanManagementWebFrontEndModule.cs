...
namespace RSCO.LoanManagement.Web.Public.Startup
{
    [DependsOn(
        typeof(LoanManagementWebCoreModule)
    )]
    public class LoanManagementWebFrontEndModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public LoanManagementWebFrontEndModule(IWebHostEnvironment env, LoanManagementEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(LoanManagementWebFrontEndModule).GetAssembly());
        }
    }
}
