...
using RSCO.LoanManagement.Web.Public.Startup;
using RSCO.LoanManagement.Web.Session;
using RSCO.LoanManagement.Web.UiCustomization;

namespace RSCO.LoanManagement.Web.Public.Views.Shared.Components.Header
{
    public class HeaderViewComponent : LoanManagementViewComponent
    {
