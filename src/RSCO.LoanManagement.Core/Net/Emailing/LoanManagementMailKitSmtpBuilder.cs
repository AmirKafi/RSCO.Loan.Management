...
{
    public class LoanManagementMailKitSmtpBuilder : DefaultMailKitSmtpBuilder
    {
        private readonly ILocalizationManager _localizationManager;
        private readonly IEmailSettingsChecker _emailSettingsChecker;
        
        public LoanManagementMailKitSmtpBuilder(
        ...
        {
            return _localizationManager.GetString(LoanManagementConsts.LocalizationSourceName, name);
        }
