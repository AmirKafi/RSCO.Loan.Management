...
namespace RSCO.LoanManagement.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : LoanManagementServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("RSCO.LoanManagement", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
