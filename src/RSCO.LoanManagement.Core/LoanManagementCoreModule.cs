...
using RSCO.LoanManagement.Authorization.Ldap;
...
{
    [DependsOn(
        typeof(LoanManagementCoreSharedModule),
    ...
    public class LoanManagementCoreModule : AbpModule
    {
        public override void PreInitialize()
        {
            ...
            Configuration.ReplaceService<IMailKitSmtpBuilder, LoanManagementMailKitSmtpBuilder>(DependencyLifeStyle.Transient);
            ...
            Configuration.ReplaceService(typeof(IEmailSenderConfiguration), () =>
            {
                Configuration.IocManager.IocContainer.Register(
                    Component.For<IEmailSenderConfiguration, ISmtpEmailSenderConfiguration>()
                             .ImplementedBy<LoanManagementSmtpEmailSenderConfiguration>()
                             .LifestyleTransient()
                );
            });
