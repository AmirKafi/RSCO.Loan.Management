...
using RSCO.LoanManagement.Localization;
...
using RSCO.LoanManagement.Net.Emailing;
...
namespace RSCO.LoanManagement.Authorization.Users
{
    ...
    /// </summary>
    public class UserEmailer : LoanManagementServiceBase, IUserEmailer, ITransientDependency
    {
        ...
        public async Task SendPasswordResetLinkAsync(User user, string link = null)
        {
            ...
            if (!link.IsNullOrEmpty())
            {
                ...
                var expireDate = Uri.EscapeDataString(Clock.Now.AddHours(expirationHours)
                    .ToString(LoanManagementConsts.DateTimeOffsetFormat, CultureInfo.InvariantCulture));
