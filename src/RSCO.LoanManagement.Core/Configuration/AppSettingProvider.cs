...
using RSCO.LoanManagement.Authentication;
...
namespace RSCO.LoanManagement.Configuration
{
    ...
    public class AppSettingProvider : SettingProvider
    {
        ...
        {
            if (!LoanManagementConsts.AllowTenantsToChangeEmailSettings)
            {
            ...
            return new[]
            {
                ...
                new SettingDefinition(AppSettings.Email.UseHostDefaultEmailSettings,
                    GetFromAppSettings(AppSettings.Email.UseHostDefaultEmailSettings,
                        LoanManagementConsts.MultiTenancyEnabled ? "true" : "false"), scopes: SettingScopes.Tenant),
        ...
        private IEnumerable<SettingDefinition> GetDashboardSettings()
        {
            ...
            return new[]
            {
                new SettingDefinition(
                    GetSettingName(
                        LoanManagementDashboardCustomizationConsts.Applications.Mvc,
                ...
                new SettingDefinition(
                    GetSettingName(
                        LoanManagementDashboardCustomizationConsts.Applications.Angular,
        ...
        public Dashboard GetDefaultMvcHostDashboardView()
        {
            ...
            {
                DashboardName = LoanManagementDashboardCustomizationConsts.DashboardNames.DefaultHostDashboard,
                Pages = new List<Page>
                {
                    new Page($"Page_{LoanManagementDashboardCustomizationConsts.DashboardNames.DefaultHostDashboard}_{LoanManagementDashboardCustomizationConsts.DefaultPageUniqueName}_{1}")
                    {
                        Name = LoanManagementDashboardCustomizationConsts.DefaultPageName,
                        Widgets = new List<Widget>
                        {
                            new Widget
                            {
                                WidgetId = LoanManagementDashboardCustomizationConsts.Widgets.Host
                                    .TopStats, // Top Stats
                                Height = 6,
                                Width = 12,
                                PositionX = 0,
                            ...
                            {
                                WidgetId =
                                    LoanManagementDashboardCustomizationConsts.Widgets.Host
        ...
        public Dashboard GetDefaultMvcTenantDashboardView()
        {
            ...
            return new Dashboard
            {
                DashboardName = LoanManagementDashboardCustomizationConsts.DashboardNames.DefaultTenantDashboard,
                Pages = new List<Page>
                {
                    new Page($"Page_{LoanManagementDashboardCustomizationConsts.DashboardNames.DefaultTenantDashboard}_{LoanManagementDashboardCustomizationConsts.DefaultPageUniqueName}_{1}")
                    {
                        Name = LoanManagementDashboardCustomizationConsts.DefaultPageName,
                        Widgets = new List<Widget>
                        {
                            new Widget
                            {
                                WidgetId = LoanManagementDashboardCustomizationConsts.Widgets.Tenant
                            ...
                            {
                                WidgetId =
                                    LoanManagementDashboardCustomizationConsts.Widgets.Tenant
