...
/// </summary>
public class LoanManagementSimplePermissionDependency : IPermissionDependency
{
    /// <summary>
    ...
    /// </summary>
    public LoanManagementSimplePermissionDependency()
    {
    ...
    public LoanManagementSimplePermissionDependency(params string[] permissions)
    {
    ...
    /// </param>
    /// <param name="permissions">The permissions.</param>
    public LoanManagementSimplePermissionDependency(bool requiresAll, params string[] permissions)
        : this(permissions)
    {
