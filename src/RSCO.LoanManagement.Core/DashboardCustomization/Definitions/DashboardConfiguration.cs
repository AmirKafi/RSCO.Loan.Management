...
using RSCO.LoanManagement.DashboardCustomization.Definitions.Cache;

namespace RSCO.LoanManagement.DashboardCustomization.Definitions
{
    public class DashboardConfiguration : ITransientDependency
    {
            ...
            IAbpSession abpSession)
        {
            ...
            var simplePermissionDependencyForTenantDashboard =
                new LoanManagementSimplePermissionDependency(AppPermissions.Pages_Tenant_Dashboard);
            ...
            var generalStats = new WidgetDefinition(
                ...
                "WidgetGeneralStats",
                side: MultiTenancySides.Tenant,
                permissionDependency: new LoanManagementSimplePermissionDependency(
                    requiresAll: true,
            ...
            var simplePermissionDependencyForHostDashboard =
                new LoanManagementSimplePermissionDependency(AppPermissions.Pages_Administration_Host_Dashboard);
            ...
            var defaultTenantDashboard = new DashboardDefinition(
                LoanManagementDashboardCustomizationConsts.DashboardNames.DefaultTenantDashboard,
                new List<string>
                {
            ...
            var defaultHostDashboard = new DashboardDefinition(
                LoanManagementDashboardCustomizationConsts.DashboardNames.DefaultHostDashboard,
                new List<string>
                {
                    incomeStatistics.Id,
                    hostTopStats.Id,
