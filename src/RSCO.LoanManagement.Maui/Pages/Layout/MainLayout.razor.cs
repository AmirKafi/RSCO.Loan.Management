...
using RSCO.LoanManagement.Maui.Core.Helpers;
using RSCO.LoanManagement.Maui.Core.Localization;
using RSCO.LoanManagement.Maui.Services.Account;
using RSCO.LoanManagement.Maui.Services.Navigation;
using RSCO.LoanManagement.Maui.Services.Tenants;
using RSCO.LoanManagement.Maui.Services.UI;
using Plugin.Connectivity;

#if ANDROID
using RSCO.LoanManagement.Maui.Core.Platforms.Android.HttpClient;
#endif
#if IOS
using RSCO.LoanManagement.Maui.Core.Platforms.iOS.HttpClient;
#endif

namespace RSCO.LoanManagement.Maui.Pages.Layout
{
