...
using RSCO.LoanManagement.Schemas;
using RSCO.LoanManagement.Web.Chat.SignalR;
using RSCO.LoanManagement.Web.Common;
using RSCO.LoanManagement.Web.Resources;
using Swashbuckle.AspNetCore.Swagger;
using RSCO.LoanManagement.Web.Swagger;
using Stripe;
...
using RSCO.LoanManagement.Web.HealthCheck;
using Owl.reCAPTCHA;
using Microsoft.AspNetCore.Server.Kestrel.Https;
using Microsoft.Extensions.DependencyInjection.Extensions;
using RSCO.LoanManagement.Web.Extensions;
using RSCO.LoanManagement.Web.MultiTenancy;
using RSCO.LoanManagement.Web.OpenIddict;
using SecurityStampValidatorCallback = RSCO.LoanManagement.Identity.SecurityStampValidatorCallback;
...
namespace RSCO.LoanManagement.Web.Startup
{
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            ...
            return services.AddAbp<LoanManagementWebMvcModule>(options =>
            {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            if (env.IsDevelopment())
            {
                ...
                app.UseLoanManagementForwardedHeaders();
            }
            else
            {
            ...
            if (LoanManagementConsts.PreventNotExistingTenantSubdomains)
            {
            ...
            if (WebConsts.SwaggerUiEnabled)
            {
                ...
                {
                    options.SwaggerEndpoint(_appConfiguration["App:SwaggerEndPoint"], "LoanManagement API V1");
                    options.IndexStream = () => Assembly.GetExecutingAssembly()
                        .GetManifestResourceStream("RSCO.LoanManagement.Web.wwwroot.swagger.ui.index.html");
        ...
        private void ConfigureSwagger(IServiceCollection services)
        {
            ...
            {
                options.SwaggerDoc("v1", new OpenApiInfo() {Title = "LoanManagement API", Version = "v1"});
                ...
                var applicationXml = $"RSCO.LoanManagement.Application.xml";
                var applicationXmlPath = Path.Combine(AppContext.BaseDirectory, applicationXml);
                options.IncludeXmlComments(applicationXmlPath);

                var webCoreXmlFile = $"RSCO.LoanManagement.Web.Core.xml";
