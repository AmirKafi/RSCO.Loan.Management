...
using RSCO.LoanManagement.UiCustomization.Dto;

namespace RSCO.LoanManagement.Web.TagHelpers
{
    ...
    public class LoanManagementPageSubheaderTagHelper : TagHelper
    {
        ...
        public LoanManagementPageSubheaderTagHelper(IUiThemeCustomizerFactory uiThemeCustomizerFactory)
        {
