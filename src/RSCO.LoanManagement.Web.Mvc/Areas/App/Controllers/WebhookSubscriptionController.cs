...
using RSCO.LoanManagement.Web.Areas.App.Models.Webhooks;
using RSCO.LoanManagement.Web.Controllers;
using RSCO.LoanManagement.WebHooks;
...
namespace RSCO.LoanManagement.Web.Areas.App.Controllers
{
    ...
    public class WebhookSubscriptionController : LoanManagementControllerBase
    {
