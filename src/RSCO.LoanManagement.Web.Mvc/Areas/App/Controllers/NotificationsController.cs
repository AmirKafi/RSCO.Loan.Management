...
using RSCO.LoanManagement.Organizations;
using RSCO.LoanManagement.Web.Areas.App.Models.Notifications;
using RSCO.LoanManagement.Web.Areas.App.Models.OrganizationUnits;
...
namespace RSCO.LoanManagement.Web.Areas.App.Controllers
{
    [Area("App")]
    [AbpMvcAuthorize]
    public class NotificationsController : LoanManagementControllerBase
    {
