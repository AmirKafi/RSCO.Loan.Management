...
using RSCO.LoanManagement.Web.Areas.App.Models.Languages;
...
namespace RSCO.LoanManagement.Web.Areas.App.Controllers
{
    ...
    public class LanguagesController : LoanManagementControllerBase
    {
            ...
            string filterText = "")
        {
            ...
            {
                sourceName = LoanManagementConsts.LocalizationSourceName;
            }
