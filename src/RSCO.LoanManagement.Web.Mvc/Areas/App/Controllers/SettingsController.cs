...
using RSCO.LoanManagement.Configuration.Tenants;
...
using RSCO.LoanManagement.Web.Areas.App.Models.Settings;
...
namespace RSCO.LoanManagement.Web.Areas.App.Controllers
{
    ...
    public class SettingsController : LoanManagementControllerBase
    {
