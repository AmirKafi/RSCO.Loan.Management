...
using RSCO.LoanManagement.DynamicEntityProperties;
using RSCO.LoanManagement.DynamicEntityProperties.Dto;
using RSCO.LoanManagement.Web.Areas.App.Models.DynamicEntityProperty;
...
namespace RSCO.LoanManagement.Web.Areas.App.Controllers
{
    ...
    public class DynamicEntityPropertyController : LoanManagementControllerBase
    {
