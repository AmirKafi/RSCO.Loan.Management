...
using RSCO.LoanManagement.Configuration.Host;
using RSCO.LoanManagement.Editions;
using RSCO.LoanManagement.Timing;
using RSCO.LoanManagement.Timing.Dto;
using RSCO.LoanManagement.Web.Areas.App.Models.HostSettings;
...
namespace RSCO.LoanManagement.Web.Areas.App.Controllers
{
    ...
    public class HostSettingsController : LoanManagementControllerBase
    {
