...
namespace RSCO.LoanManagement.Web.Areas.App.Views.Shared.Themes.Default.Components.AppDefaultFooter
{
    public class AppDefaultFooterViewComponent : LoanManagementViewComponent
    {
