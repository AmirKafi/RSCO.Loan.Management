...
namespace RSCO.LoanManagement.Web.Areas.App.Views.Shared.Themes.Theme6.Components.AppTheme6Brand
{
    public class AppTheme6BrandViewComponent : LoanManagementViewComponent
    {
