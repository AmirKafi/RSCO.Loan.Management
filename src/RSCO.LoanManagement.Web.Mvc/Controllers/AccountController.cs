...
using RSCO.LoanManagement.Debugging;
...
{
    public class AccountController : LoanManagementControllerBase
    {
            ...
            string returnUrlHash = "", string ss = "")
        {
            ...
            if (loginResult.User.ShouldChangePasswordOnNextLogin)
            {
                ...
                var expireDate =
                    Uri.EscapeDataString(Clock.Now.AddHours(1).ToString(LoanManagementConsts.DateTimeOffsetFormat));
