...
using RSCO.LoanManagement.Core.Base;
using RSCO.LoanManagement.Core.Extensions;
using RSCO.LoanManagement.Dto;
using RSCO.LoanManagement.Types;

namespace RSCO.LoanManagement.Queries
{
    public class OrganizationUnitQuery : LoanManagementQueryBase<ListGraphType<OrganizationUnitType>, List<OrganizationUnitDto>>
    {
