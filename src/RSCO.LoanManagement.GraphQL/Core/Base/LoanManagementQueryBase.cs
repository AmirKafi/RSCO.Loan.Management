...
namespace RSCO.LoanManagement.Core.Base
{
    public abstract class LoanManagementQueryBase<TField,TResult> : ITransientDependency
    {
        ...
        protected LoanManagementQueryBase(string fieldName,
