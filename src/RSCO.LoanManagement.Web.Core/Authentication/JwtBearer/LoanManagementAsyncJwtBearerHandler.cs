...
{
    public class LoanManagementAsyncJwtBearerHandler : AuthenticationHandler<AsyncJwtBearerOptions>
    {
        ...
        /// </summary>
        /// <inheritdoc />
        public LoanManagementAsyncJwtBearerHandler(IOptionsMonitor<AsyncJwtBearerOptions> options,
