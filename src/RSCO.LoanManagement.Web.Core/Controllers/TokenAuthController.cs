...
using RSCO.LoanManagement.Authentication.TwoFactor;
...
using RSCO.LoanManagement.Web.Authentication.JwtBearer;
using RSCO.LoanManagement.Web.Authentication.TwoFactor;
using RSCO.LoanManagement.Web.Models.TokenAuth;
using RSCO.LoanManagement.Authorization.Impersonation;
using RSCO.LoanManagement.Authorization.Roles;
using RSCO.LoanManagement.Configuration;
using RSCO.LoanManagement.Identity;
using RSCO.LoanManagement.Net.Sms;
using RSCO.LoanManagement.Notifications;
using RSCO.LoanManagement.Security.Recaptcha;
using RSCO.LoanManagement.Web.Authentication.External;
using RSCO.LoanManagement.Web.Common;
using RSCO.LoanManagement.Authorization.Delegation;
using Abp.Runtime.Validation;
using RSCO.LoanManagement.Authorization.PasswordlessLogin;

namespace RSCO.LoanManagement.Web.Controllers
{
    [Route("api/[controller]/[action]")]
    public class TokenAuthController : LoanManagementControllerBase
    {
        ...
        private async Task<string> EncryptQueryParameters(long userId, Tenant tenant, string passwordResetCode)
        {
            ...
            var expireDate = Uri.EscapeDataString(Clock.Now.AddHours(expirationHours)
                .ToString(LoanManagementConsts.DateTimeOffsetFormat));
