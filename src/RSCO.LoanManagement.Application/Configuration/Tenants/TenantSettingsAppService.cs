...
using RSCO.LoanManagement.Configuration.Tenants.Dto;
using RSCO.LoanManagement.Security;
using RSCO.LoanManagement.Storage;
using RSCO.LoanManagement.Timing;

namespace RSCO.LoanManagement.Configuration.Tenants
{
    ...
    public class TenantSettingsAppService : SettingsAppServiceBase, ITenantSettingsAppService
    {
        ...
        {
            if (_multiTenancyConfig.IsEnabled && !LoanManagementConsts.AllowTenantsToChangeEmailSettings)
            {
                return;
            }
