...
using RSCO.LoanManagement.DashboardCustomization.Definitions;
using RSCO.LoanManagement.DashboardCustomization.Dto;

namespace RSCO.LoanManagement.DashboardCustomization
{
    [AbpAuthorize]
    public class DashboardCustomizationAppService : LoanManagementAppServiceBase, IDashboardCustomizationAppService
    {
