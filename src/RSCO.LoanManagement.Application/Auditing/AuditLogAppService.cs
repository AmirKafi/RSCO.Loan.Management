...
using RSCO.LoanManagement.Auditing.Exporting;
...
using EntityHistoryHelper = RSCO.LoanManagement.EntityHistory.EntityHistoryHelper;

namespace RSCO.LoanManagement.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : LoanManagementAppServiceBase, IAuditLogAppService
    {
