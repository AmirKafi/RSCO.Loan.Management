...
using RSCO.LoanManagement.Migrations.Seed;
using RSCO.LoanManagement.Migrations.Seed.Host;
...
namespace RSCO.LoanManagement.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : LoanManagementAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<LoanManagementDbContext> _migrator;
        ...
        {
            var connectionString = _appConfiguration[$"ConnectionStrings:{LoanManagementConsts.ConnectionStringName}"];
        ...
        {
            EditAppSettingsjson($"ConnectionStrings:{LoanManagementConsts.ConnectionStringName}", constring);
        }
