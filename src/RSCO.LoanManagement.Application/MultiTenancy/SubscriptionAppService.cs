...
{
    public class SubscriptionAppService : LoanManagementAppServiceBase, ISubscriptionAppService
    {
        ...
        {
            return upgradeAmount < LoanManagementConsts.MinimumUpgradePaymentAmount;
        }
