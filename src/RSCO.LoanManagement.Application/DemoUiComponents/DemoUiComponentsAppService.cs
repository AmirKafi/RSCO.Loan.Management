...
using RSCO.LoanManagement.DemoUiComponents.Dto;

namespace RSCO.LoanManagement.DemoUiComponents
{
    [AbpAuthorize(AppPermissions.Pages_DemoUiComponents)]
    public class DemoUiComponentsAppService : LoanManagementAppServiceBase, IDemoUiComponentsAppService
    {
