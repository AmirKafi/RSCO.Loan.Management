...
using RSCO.LoanManagement.Authentication.PasswordlessLogin;
using RSCO.LoanManagement.Authorization.PasswordlessLogin;

namespace RSCO.LoanManagement.Authorization.Accounts
{
    public class AccountAppService : LoanManagementAppServiceBase, IAccountAppService
    {
        ...
        private async Task SendSmsPasswordlessCode(string phoneNumber)
        {
            ...
            var message = string.Format(L("PasswordlessLogin_SmsMessage", LoanManagementConsts.ProductName, code));
