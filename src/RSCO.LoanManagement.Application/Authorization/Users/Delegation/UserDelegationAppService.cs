...
namespace RSCO.LoanManagement.Authorization.Users.Delegation
{
    [AbpAuthorize]
    public class UserDelegationAppService : LoanManagementAppServiceBase, IUserDelegationAppService
    {
