...
using RSCO.LoanManagement.Authorization.Users.Profile.Cache;
    ...
    public class ProfileAppService : LoanManagementAppServiceBase, IProfileAppService
    {
        ...
        public async Task<CurrentUserProfileEditDto> GetCurrentUserProfileForEdit()
        {
            ...
            userProfileEditDto.QrCodeSetupImageUrl = user.GoogleAuthenticatorKey != null
                ? _googleTwoFactorAuthenticateService.GenerateSetupCode("RSCO.LoanManagement",
