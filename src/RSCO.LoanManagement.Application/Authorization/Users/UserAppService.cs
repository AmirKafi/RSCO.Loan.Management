...
using RSCO.LoanManagement.Authorization.Permissions;
...
using RSCO.LoanManagement.Authorization.Users.Exporting;
using RSCO.LoanManagement.Dto;
using RSCO.LoanManagement.Exporting;
...
namespace RSCO.LoanManagement.Authorization.Users
{
    ...
    public class UserAppService : LoanManagementAppServiceBase, IUserAppService
    {
