...
using RSCO.LoanManagement.Features;
...
{
    public class SessionAppService : LoanManagementAppServiceBase, ISessionAppService
    {
            ...
            return await _unitOfWorkManager.WithUnitOfWorkAsync(async () =>
            {
                var output = new GetCurrentLoginInformationsOutput
                {
                    Application = new ApplicationInfoDto
                    {
                        ...
                        Currency = LoanManagementConsts.Currency,
                        CurrencySign = LoanManagementConsts.CurrencySign,
                        AllowTenantsToChangeEmailSettings = LoanManagementConsts.AllowTenantsToChangeEmailSettings,
