...
{
    public class SubscriptionPaymentRepository : LoanManagementRepositoryBase<SubscriptionPayment, long>,
        ISubscriptionPaymentRepository
    {
        public SubscriptionPaymentRepository(IDbContextProvider<LoanManagementDbContext> dbContextProvider)
