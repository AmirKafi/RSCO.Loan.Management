...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RSCO.LoanManagement.Authorization.Delegation.UserDelegation", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("RSCO.LoanManagement.Authorization.Users.RecentPassword", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("RSCO.LoanManagement.MultiTenancy.Payments.SubscriptionPaymentExtensionData", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("RSCO.LoanManagement.OpenIddict.Applications.OpenIddictApplication", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("RSCO.LoanManagement.OpenIddict.Authorizations.OpenIddictAuthorization", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("RSCO.LoanManagement.OpenIddict.Scopes.OpenIddictScope", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("RSCO.LoanManagement.OpenIddict.Tokens.OpenIddictToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("RSCO.LoanManagement.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("RSCO.LoanManagement.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("RSCO.LoanManagement.OpenIddict.Authorizations.OpenIddictAuthorization", b =>
                {
                    b.HasOne("RSCO.LoanManagement.OpenIddict.Applications.OpenIddictApplication", null)
                        .WithMany()
            ...
            modelBuilder.Entity("RSCO.LoanManagement.OpenIddict.Tokens.OpenIddictToken", b =>
                {
                    ...
                    b.HasOne("RSCO.LoanManagement.OpenIddict.Authorizations.OpenIddictAuthorization", null)
                        .WithMany()
