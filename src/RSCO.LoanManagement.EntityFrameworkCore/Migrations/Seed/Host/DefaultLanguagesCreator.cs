...
namespace RSCO.LoanManagement.Migrations.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = LoanManagementConsts.MultiTenancyEnabled ? null : (int?)1;
        ...
        public DefaultLanguagesCreator(LoanManagementDbContext context)
        {
            _context = context;
        }
