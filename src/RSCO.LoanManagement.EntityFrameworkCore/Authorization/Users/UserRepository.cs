...
{
    public class UserRepository : LoanManagementRepositoryBase<User, long>, IUserRepository
    {
        public UserRepository(IDbContextProvider<LoanManagementDbContext> dbContextProvider)
