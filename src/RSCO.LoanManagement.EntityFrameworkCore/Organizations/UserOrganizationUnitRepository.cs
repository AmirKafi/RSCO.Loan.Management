...
using RSCO.LoanManagement.EntityFrameworkCore.Repositories;

namespace RSCO.LoanManagement.Organizations
{
    public class UserOrganizationUnitRepository : LoanManagementRepositoryBase<UserOrganizationUnit, long>,
        IUserOrganizationUnitRepository
    {
        public UserOrganizationUnitRepository(IDbContextProvider<LoanManagementDbContext> dbContextProvider)
