...
using RSCO.LoanManagement.EntityHistory;
...
namespace RSCO.LoanManagement.EntityFrameworkCore
{
    ...
    public class LoanManagementEntityFrameworkCoreModule : AbpModule
    {
        ...
        public override void PreInitialize()
        {
            if (!SkipDbContextRegistration)
            {
                Configuration.Modules.AbpEfCore().AddDbContext<LoanManagementDbContext>(options =>
                {
                    ...
                    {
                        LoanManagementDbContextConfigurer.Configure(options.DbContextOptions,
            ...
            // Configuration.EntityHistory.Selectors.Add("RSCO.LoanManagementEntities", EntityHistoryHelper.TrackedTypes);
            // Configuration.CustomConfigProviders.Add(new EntityHistoryConfigProvider(Configuration));
        }

        public override void Initialize()
        {
            IocManager.RegisterAssemblyByConvention(typeof(LoanManagementEntityFrameworkCoreModule).GetAssembly());
        }
