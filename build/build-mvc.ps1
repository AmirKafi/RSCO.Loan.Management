...
$webMvcFolder = Join-Path $slnFolder "src/RSCO.LoanManagement.Web.Mvc"
$webPublicFolder = Join-Path $slnFolder "src/RSCO.LoanManagement.Web.Public"
...
dotnet restore RSCO.LoanManagement.Web.sln
