...
using RSCO.LoanManagement.MultiTenancy.HostDashboard;
...
namespace RSCO.LoanManagement.Tests.HostDashboard
{
    ...
    public class HostDashboardAppService_Tests : AppTestBase
    {
        ...
        private void CreatePaidPayment(LoanManagementDbContext context, SubscriptionPayment subscriptionPayment)
        {
